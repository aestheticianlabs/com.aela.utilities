...
// Source: https://github.com/JohannesMP/unity-scene-reference/blob/master/unity-scene-reference/Assets/source/SceneReference.cs
...
namespace AeLa.Utilities
{
	...
	public class SceneReferencePropertyDrawer : PropertyDrawer
	{
				...
				if (property.isExpanded)
				{
					...
					EditorGUI.BeginChangeCheck();
					{
						...
						sceneAssetProperty.objectReferenceValue = EditorGUI.ObjectField(
							position, sceneAssetProperty.objectReferenceValue, typeof(SceneAsset), false
						);
					}
		...
		private void DrawSceneInfoGUI(Rect position, BuildUtils.BuildScene buildScene, int sceneControlID)
		{
			...
			if (DrawUtils.ButtonHelper(
				buttonRect, "Settings", "Build Settings", EditorStyles.miniButtonRight, tooltipMsg
			))
			{
		...
		private static class DrawUtils
		{
			...
			public static bool ButtonHelper(
				Rect position, string msgShort, string msgLong, GUIStyle style, string tooltip = null
			)
			{
