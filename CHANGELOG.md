...
- `Util.Math.GCD(int a, int b)`

## [1.11.0] - 2026-03-13

### Added

- `Util.Text` with helpful text utilities
- `StringExtensions` with helpful string formatting extensions

## [1.10.0] - 2026-03-12

### Changed

- Move `Pool` namespace to `Pooling`

### Added

- `PooledArray`
- `PooledList`
- `Util.Math.Approximately` helper function

## [1.9.0]

### Added

- StackPool<T> (like Unity's CollectionPool<T> API, but for Stacks)

## [1.8.0] - 2025-11-06

### Changed

- Replacee references to deprecated `RigidBody.velocity` property with `RigidBody.linearVelocity`

## [1.7.2] - 2025-05-19

### Changed

- Allow `WeightedRandomList` to be extended
